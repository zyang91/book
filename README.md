...
This cookiecutter creates a simple boilerplate for a Jupyter Book. updared
...
We welcome and recognize all contributions. You can see a list of current contributors in the [contributors tab](https://github.com/zyang91/my-book/graphs/contributors).
